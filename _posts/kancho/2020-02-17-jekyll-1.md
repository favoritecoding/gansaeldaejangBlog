...
<img data-action="zoom" src='{{ "/assets/kanchoImg/jekyll//0-1.PNG" | absolute_url }}' alt='absolute'> 
...
<img data-action="zoom" src='{{ "/assets/kanchoImg/jekyll//0-2.PNG" | absolute_url }}' alt='absolute'>
...
<img data-action="zoom" src='{{ "/assets/kanchoImg/jekyll//0-2-1.PNG" | absolute_url }}' alt='absolute'>
...
<img data-action="zoom" src='{{ "/assets/kanchoImg/jekyll//0-3.PNG" | absolute_url }}' alt='absolute'> 
...
<img data-action="zoom" src='{{ "/assets/kanchoImg/jekyll//0-4.PNG" | absolute_url }}' alt='absolute'>
...
<img data-action="zoom" src='{{ "/assets/kanchoImg/jekyll//0-5.PNG" | absolute_url }}' alt='absolute'> 
...
<img data-action="zoom" src='{{ "/assets/kanchoImg/jekyll//0-6.PNG" | absolute_url }}' alt='absolute'>
...
<img data-action="zoom" src='{{ "/assets/kanchoImg/jekyll//0-7.PNG" | absolute_url }}' alt='absolute'>
...
<img data-action="zoom" src='{{ "/assets/kanchoImg/jekyll//0-8.PNG" | absolute_url }}' alt='absolute'>
